...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset_sign", type=str, choices=["ontonotes4", "msra", "conll03", "ace04", "ace05", "gpt"], default="conll03")
...
def main():
    ...
    for batch in tqdm(data_loader):
        ...
        # print("*="*10)
        output_dict.append({'input_context':readable_input_str, 'output_entity':entity_lst})
    ...
    with open(args.data_dir+'/predict.json', 'w') as f:
